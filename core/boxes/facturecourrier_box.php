 ...
 */
class facturecourrierbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "facturecourrier@facturecourrier";
    public $boxlabel;
    public $depends = array("facturecourrier");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/facturecourrier/class/facturecourrier.class.php";
