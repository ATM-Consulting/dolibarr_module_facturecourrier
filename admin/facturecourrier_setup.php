...
/**
 * 	\file		admin/facturecourrier.php
...
require_once '../lib/facturecourrier.lib.php';
 ...
 * View
 */
$page_name = "FactureCourrierSetup";
...
$head = facturecourrierAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104901Name"),
    0,
    "facturecourrier@facturecourrier"
);
